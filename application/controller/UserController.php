...
class UserController extends Controller
{
    ...
    // USER CATEGORY SHIT IN SESSION SPEICHERN!


         if ( !empty ($_POST["category"]) || !empty ($_POST["learn"])) {
            $selectedCategorys = "";
             ...
             foreach($_POST['learn'] as $value2){
                 if ($value2 == "yes"){
                     $selectedCategorys = $selectedCategorys.";learn";
                 }
                 if ($value2 == "no"){
             ...
             UserModel::setSelectedCategorys($selectedCategorys, Session::get('user_id'));
        }

        $user_selectedCategorys = UserModel::getSelectedCategorys(Session::get('user_id'));
        UserModel::categoriesToSession($user_selectedCategorys);


        $user_categoryPercentages = UserModel::getAllCategoryPercentages(Session::get('user_id'));
        ...
        $this->View->render('user/index', array(
            ...
            'user_selectedCategorys' => $user_selectedCategorys,
            'user_categoryPercentages' => $user_categoryPercentages
        ));
